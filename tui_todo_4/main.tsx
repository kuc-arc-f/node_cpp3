...
export const agentFunc = async (modelName: string, prompt: string) => {
...
function SearchCommandLine() {
  ...
  const handleSubmit = async (value) => {
    ...
    let targetStr = value;
    const resp = await agentFunc(MODEL_NAME, targetStr);
...
//const PROMPT_STR = "todoList TODO一覧を取得したい。";
const main = async function(){
  ...
  //await agentFunc(MODEL_NAME, PROMPT_STR);
}
main();